class UserProfileField < ActiveRecord::Base
  ...
  validates_presence_of :values, :if => Proc.new{|field| field.display_type != "text_area" || "picture_link"}
  ...
  DISPLAY_TYPE_OPTIONS = {"Text Field"   => "text_field",
                          ...
                          "Profile Picture (on the server)" => "upload_pic"
                          }
  ...
  DISPLAY_TYPE_VIEW = {"text_field"   => "Text Field",
                        ...
                        "upload_pic" => "Profile Picture (on the server)"
                          }
