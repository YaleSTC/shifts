...
map <NL> :execute "tabmove" tabpagenr() 
...
set ignorecase
set mouse=a
set runtimepath=~/.vim/bundle/vundle,~/.vim/bundle/YouCompleteMe,~/.vim,~/.vim/bundle/nerdtree,~/.vim/bundle/vim-colors-solarized,/usr/share/vim/vimfiles,/usr/share/vim/vim74,/usr/share/vim/vimfiles/after,~/.vim/after,~/.vim/bundle/vundle/,~/.vim/bundle/vundle/after,~/.vim/bundle/YouCompleteMe/after
set shiftwidth=2
set smartcase
set smarttab
set softtabstop=2
...
set shortmess=aoO
badd +44 NERD_tree_1
badd +11 app/views/layouts/include/main_header.html.erb
badd +1 app/views/layouts/time_slots.html.erb
badd +6 app/views/layouts/shifts.html.erb
badd +5 app/views/shifts/_shifts_layout.html.erb
badd +14 app/views/time_slots/index.html.erb
badd +2 app/models/shift.rb
args .
edit app/models/shift.rb
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 492 - ((18 * winheight(0) + 22) / 44)
