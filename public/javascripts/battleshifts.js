...
//     for (x=0;x<gridx;++x) {
//       if ( ispc ) {
//         $('#bs_opponent').append('<a href="javascript:gridClick('+y+','+x+');"><img name="pc'+y+'_'+x+'" src="http://weke.its.yale.edu/apps2/images/battleshifts/batt100.gif" width=16 height=16></a>');
//       } else {
//         $('#bs_player').append('<a href="javascript:void(0);"><img name="ply'+y+'_'+x+'" src="http://weke.its.yale.edu/apps2/images/battleshifts/batt'+player[y][x][0]+'.gif" width=16 height=16></a>');
//       }
//     }
//       if ( ispc ) {
//         $('#bs_opponent').append('<br>');
//       }
//       else {
//         $('#bs_player').append('<br>'); 
//       }
