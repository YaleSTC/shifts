...
ActiveRecord::Schema.define(:version => 20090617204430) do
  ...
  create_table "location_source_links", :id => false, :force => true do |t|
  ...
  create_table "user_source_links", :id => false, :force => true do |t|
